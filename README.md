...
| `specs/` | 现行规格（含上下文 / 聪明程度 / 设置系统 / 云端模板 / 评测台） |
...
规格：`specs/2026-08-13-WPS设置系统设计.md`、`specs/2026-08-13-WPS校对内容重复.md`、`specs/2026-08-13-WPS云端模板一对一复刻.md`
