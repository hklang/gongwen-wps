...
- **撰写**：点选 **一级/二级/三级/正文**（可多选）→ 可钉范围 → **出结论/给多份** → 卡片落稿。勾「出结论」发送前自动存整篇到 `版本/自动/`（只留 10 份，工程栏不列出）；助手气泡 **还原本轮** 点了即还（无对应文件则灰）。纯聊天不存。
- **精修**：钉住 → 充填 / 润色出方案 → 预览 / 采用；钉住旁 **还原选区**；出方案同样存自动档，可 **还原本轮**；**再钉住会清空旧方案**
- 写回保留段末回车，避免与下一段粘连

规格：`specs/2026-08-13-02-WPS设置系统设计.md`、`specs/2026-08-13-03-WPS校对内容重复.md`、`specs/2026-08-13-04-WPS云端模板一对一复刻.md`、`specs/2026-08-13-05-WPS版本夹双轨与恢复.md`
